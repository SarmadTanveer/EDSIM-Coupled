...
def app():
    ...
    with st.form('simulationParameters'):
        ...
        with col1:
            docs = st.number_input('# of Doctors', 1, 20, 2, help="Min=1, Max=20")
        with col2:
            nurse = st.number_input('# of Nurses', 1, 20, 5, help="Min=1, Max=20")
        with col3:
            beds = st.number_input('# of Beds', 1, 40, 10, help="Min=1, Max=40")
        with col4:     
            resbeds = st.number_input('# of Resuscitation Bed', 1, 20, 5, help="Min=1, Max=20")
        ...
        with col6: 
            simPar_iterations = st.number_input('Iterations', 1, 40, 18, help="Min=1, Max=40")
        with col7: 
            simPar_warmUp = st.number_input('Warm Up Period', 1, 120, 10, help="Min=1, Max=120")
